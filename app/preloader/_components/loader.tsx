...
export const Loader = () => {
  ...
  // Uses the quadratic bezier curve to create a curved path
  ...
  return (
    <motion.div
      ...
      initial='initial'
      exit='exit'
      className='h-screen w-screen flex items-center justify-center fixed z-50 bg-black text-white'
    >
      {dimension.height > 0 && (
        <>
          <motion.p
            ...
            initial='initial'
            animate='enter'
            className='flex text-white text-4xl absolute items-center z-10'
          >
            {words[index]}
          </motion.p>
